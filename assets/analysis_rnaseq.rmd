...
cat("###", make_link("Explore Differentially Expressed Gene Analysis in BioTools Portal", "https://compbio/"), "\n\n")
...
file_path <- file.path(folder_path, "Spearman_Correlations_Coefficient_Heatmap.pdf")

ggsave(filename = file_path, plot = g, device = "pdf", width = 30, height = 30, units = "in", limitsize = FALSE)
...
file_path <- file.path(folder_path, "Spearman_Correlations_Coefficient_Heatmap_hier.pdf")
